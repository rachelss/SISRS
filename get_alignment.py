...
for species in pathlist:
    ...
    print 'Reading pickled data: '+species+'/pruned_dict.pkl'
...
for loc in alllocs: #go through each location
    ...
    if len(snp)<(len(pathlist)-int(sys.argv[1])):   #missing info for more than one indiv - flag
        flag=2
